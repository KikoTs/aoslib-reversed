...
if sys.version_info[0] < 3:
    # For Python 2, set "aosdump" as root directory (at project root, not tests/)
    script_dir = os.path.dirname(os.path.abspath(__file__))
    parent_dir = os.path.dirname(script_dir)  # Go up from tests/ to project root
    root_dir = os.path.join(parent_dir, "aosdump")
    os.chdir(root_dir)
    sys.path.insert(0, root_dir)
else:
    # For Python 3+, add parent directory to path
    script_dir = os.path.dirname(os.path.abspath(__file__))
...
def test_state_data(): # not 1:1
    ...
    current_packet.has_map_ended = 1  # Changed to 1
    current_packet.light_color = (17,18,19)
    current_packet.light_direction = (20,21,22)
    current_packet.lock_spectator_swap = 0
    current_packet.lock_team_swap = 0
    current_packet.mode_type = 25
    current_packet.player_id = 26
    current_packet.prefabs = ["test1", "test2"]
    ...
    current_packet.team1_can_see_team2 = 0
    current_packet.team1_classes = [1,2,3]
    current_packet.team1_color = (38,39,40)
    current_packet.team1_infinite_blocks = 0
    current_packet.team1_locked = 1
    current_packet.team1_locked_class = 0  # Changed to 0
    current_packet.team1_locked_score = 0
    current_packet.team1_name = "test"
    current_packet.team1_score = 45
    current_packet.team1_show_max_score = 1
    current_packet.team1_show_score = 0
    current_packet.team2_can_see_team1 = 0
    current_packet.team2_classes = [1,2,3]
    current_packet.team2_color = (52,53,54)
    current_packet.team2_infinite_blocks = 0  # Changed to 0
    current_packet.team2_locked = 0  # Changed to 0
    current_packet.team2_locked_class = 0  # Changed to 0
    current_packet.team2_locked_score = 0  # Changed to 0
    current_packet.team2_name = "test"
    current_packet.team2_score = 59
    current_packet.team2_show_max_score = 0  # Changed to 0
    current_packet.team2_show_score = 0  # Changed to 0
