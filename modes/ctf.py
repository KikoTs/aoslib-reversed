...
"""
    ...
    def start(self):
        ...
        # self.protocol.create_entity(types.AmmoCrate, position=self.get_random_pos(team1), team=team1, color=team1.color)

        # self.team1_intel = self.protocol.create_entity(types.Flag, position=self.get_random_pos(team1), team=team1, color=team1.color)
        # self.team2_intel = self.protocol.create_entity(types.Flag, position=self.get_random_pos(team2), team=team2, color=team2.color)
