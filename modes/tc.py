...
class TC(GameMode):
    id = constants.MODE.TERRITORY.value
    name = "Territory Control"

    title = "TC_TITLE"
    description_key = "TC_DESCRIPTION"
    info_text1 = "TC_INFOGRAPHIC_TEXT1"
    info_text2 = "TC_INFOGRAPHIC_TEXT2"
    info_text3 = "TC_INFOGRAPHIC_TEXT3"
