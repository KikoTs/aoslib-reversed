...
class DEM(GameMode):
    id = constants.MODE.DEMOLITION.value 
    name = "Demolition"

    title = "DEMOLITION_TITLE"
    description_key = "DEMOLITION_DESCRIPTION"
    info_text1 = "DEM_INFOGRAPHIC_TEXT1"
    info_text2 = "DEM_INFOGRAPHIC_TEXT2"
    info_text3 = "DEM_INFOGRAPHIC_TEXT3"
...
"""
    ...
    async def delay_plant(self, player: ServerConnection):
        ...
        for _ in reversed(range(5)):
            ...
            if player.tool_type != WEAPON.BLOCK_TOOL:
                return
